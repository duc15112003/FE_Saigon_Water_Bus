...
<div className="flex justify-center content-center">
  ...
  <label className="hidden text-gray-700 md:block">Ngày khởi hành</label>          <div className="relative w-full  border rounded border-gray-300">
          <DatePicker
              selected={startDate}
  ...
  <div className="bg-white w-full pageChuyen gap-2 flex flex-col lg:flex-row container mx-auto mb-4">
    ...
    <div className="w-full lg:w-9/12">
      <div className="flex flex-col lg:flex-row w-full justify-between">
        ...
        <div className="flex flex-col md:items-end justify-between mt-2 p-4 w-full lg:w-auto">

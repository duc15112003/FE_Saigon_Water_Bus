        ...
        <div className="">
            <section className="lkh2  px-4">
                <div className="daily">
                    ...
                    <p>
                        Mỗi ngày có 4 chuyến lượt đi, và 4 chuyến lượt về. Đi qua tất cả các bến: Bạch Đằng, Bình An,
                        Thanh Đa, Hiệp Bình Chánh và Linh Đông. Lịch trình giống nhau kể cả thứ 7, chủ nhật và ngày lễ.
                    </p>
                </div>
            </section>
            <section class=" px-4">
            ...
            <section className="lkh2  px-4">
                ...
                <div className="chuyen">
                    <p>
                        Các ngày trong tuần có 9 chuyến lượt đi, và 9 chuyến lượt về từ 17:00 đến 21:00. Thứ bảy, chủ
                        nhật và các ngày lễ: bổ sung thêm các khung giờ: 16:00, 16:30, 21:30. Chuyến Bình An Trip chỉ đi
                        qua bến Bạch Đằng và Bình An (khứ hồi).
                    </p>
                </div>
                <div className="ly">
                    <div className="luuy">
                        <p className="text-red-600 font-semibold">
                            <strong>Lưu ý</strong>: Các chuyến có đánh dấu (*) chỉ hoạt động vào thứ 7, chủ nhật và ngày
                            lễ.
                        </p>
                    </div>
                </div>

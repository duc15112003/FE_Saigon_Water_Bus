            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="block lg:hidden">
                    <button onClick={toggleMenu} className="hover:text-white focus:outline-none">
                        {isOpen ?
                            <img width="24" height="24" src="https://img.icons8.com/ios-filled/50/delete-sign--v1.png"
                                 alt="delete-sign--v1"/> :
                            <img width="24" height="24" src="https://img.icons8.com/ios-filled/36/menu--v1.png"
                                 alt="menu--v1"/>}
                    </button>
                </div>
                <div
                ...
                >
                    <div className="flex flex-col items-start py-2 w-full lg:hidden">
                        {isLoggedIn ? (
                            <div className="w-full">
                                <div className="flex flex-col items-center">
                                    ...
                                    <a href='/profile' alt='thong tin ca nhan'>
                                        <h3 className="text-black font-semibold">Tài khoản: <span
                                            className='text-sky-700'>{username}</span></h3>
                                    </a>
                                </div>
                                <div className="flex w-full mt-2 justify-center">
                                    <a className="flex items-center bg-blue-500 text-white rounded px-4 py-2 hover:bg-blue-600 focus:outline-none"
                                       href='/profile'>
                                        <div className='mr-2'>
                                    ...
                                    <button onClick={logout}
                                            className="flex items-center bg-blue-500 text-white rounded px-4 py-2 ml-2 hover:bg-blue-600 focus:outline-none">
                                        <div className='mr-2'>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                                 fill="currentColor" className="w-4 h-4">
                            ...
                            <a className="flex w-full font-bold md:text-base justify-center hover:text-gray-600 gap-2"
                               href="/login">
                    ...
                    <ul className="flex flex-col lg:flex-row lg:items-center lg:ml-auto w-full lg:w-auto lg:py-0 py-2 font-semibold">
                        <li className="lg:ml-4 ml-4">
                            <a href="/" className="block py-2 px-4 text-black hover:text-red">{t("menu.home")}</a>
                        </li>
                        <li className="lg:ml-4 ml-4">
                            <a href="/ben-tau" className="block py-2 px-4 text-black hover:text-red">{t("menu.wharf")}</a>
                        </li>
                        <li className="lg:ml-4 ml-4">
                            <a href="/lich" className="block py-2 px-4 text-black hover:text-red">{t("menu.departureSchedule")}</a>
                        </li>
                        <li className="lg:ml-4 ml-4">
                            <a href="/dat-ve" className="block py-2 px-4 text-black hover:text-red">{t("menu.bookTickets")}</a>
                        </li>
                        <li className="lg:ml-4 ml-4">
                            <a href="/contact" className="block py-2 px-4 text-black hover:text-red">{t("menu.contact")}</a>
                        </li>
                        {isLoggedIn && (
                            <li className="lg:ml-4 ml-4">
                                <a className="block py-2 px-4 text-black hover:text-red" href="/lich-su-dat-ve">{t("menu.bookingHistory")}</a>
                            </li>
                        )}
                    </ul>
                </div>

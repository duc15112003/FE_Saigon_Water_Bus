        ...
        <nav className="bg-white p-4 navbar-responsive relative z-50">
            <div className="container mx-auto flex justify-between items-center">
                <div className="text-black text-lg font-bold flex">
                  ...
                  <p className='mt-2 ml-1'>Saigon Waterbus</p>
                </div>
                ...
                <div className={`lg:flex lg:flex-row lg:items-center ${isOpen ? 'flex' : 'hidden'} flex-col lg:static absolute top-16 left-0 lg:top-0 bg-white w-full lg:w-auto border-t lg:border-none`}>
                            ...
                            <div className="ml-4">
                               ...
                               <a href='/profile' alt='thong tin ca nhan'><h3 className="text-black text-lg">{username}</h3></a>
                                <div className="flex">
                                    ...
                                    <button onClick={logout} className="mt-2 ml-2 px-4 py-2 bg-blue-500 text-white flex rounded hover:bg-blue-600 focus:outline-none w-auto">
                                      <div className='mt-1'>
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
                    ...
                    <ul className="flex flex-col lg:flex-row lg:items-center lg:ml-auto w-full lg:w-auto lg:py-0 py-4">
